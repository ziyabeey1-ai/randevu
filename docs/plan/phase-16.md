...
- **Ürün kararı (2026-09-26):** SMS, SMS hatırlatma ve SMS yaşam döngüsü kapsamdan çıkarıldı. F16-02 telefon sahipliğini Kepenk tarafından üretilen tek kullanımlık kod ve Netgsm WhatsApp OTP transportu ile doğrular. Netgsm doğrulama otoritesi değil taşıma katmanıdır; WhatsApp pazarlama/reminder kanalı bu görevin kapsamında değildir.
